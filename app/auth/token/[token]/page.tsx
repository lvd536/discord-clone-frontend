...
export default function TokenVerify() {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4 font-sans text-gray-900">
            <div className="max-width-[450px] w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-sm">
                <div className="mb-6 text-2xl font-bold text-indigo-600">⚡️ LvdCord</div>
                ...
                {status === 'error' && (
                    <button
                        ...
                        className="inline-block w-full rounded-xl bg-indigo-600 px-4 py-3 text-sm font-semibold text-white shadow-md shadow-indigo-100 transition hover:bg-indigo-700"
                    >
