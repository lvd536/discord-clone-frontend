...
# ⚡ LvdCord Web Client — Next.js Frontend
  ...
  <p>
    Современный, ультра-быстрый веб-клиент для платформы <b>LvdCord</b>. Реализован 1 в 1 в стиле Discord с поддержкой WebRTC голосовых комнат, личек и адаптивного дизайна.
  </p>
...
- 🎨 **Discord UI 1:1**:
    - Оригинальная темная палитра цветов в пространстве OKLCH (`#313338`, `#2b2d31`, `#1e1f22`, Blurple `#5865f2`).
